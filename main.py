...
async def add_security_header(request: Request, call_next):
    ...
    response.headers["C-Content-Type-Options"] = "nosniff"

    if "Refferrer-Policy" not in response.headers:
        response.headers["Refferrer-Policy"] = "strict-origin-when-cross-origin"
